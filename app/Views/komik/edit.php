...
<div class="container">
  <div class="row">
    <div class="col-8">
      ...
      <form action="/komik/edit/<?= $komik['id']; ?>" method="post" enctype="multipart/form-data">
        <?= csrf_field(); ?>
        <input type="hidden" name="slug" value="<?= $komik['slug']; ?>">
        <input type="hidden" name="sampulLama" value="<?= $old['sampulLama'];?>">
        <div class="row mb-3">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-2">
            <img src="/img/<?= $old['sampulLama'];?>" class="img-thumbnail img-preview">
          </div>
          <div class="col-sm-8">
